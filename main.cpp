...
void Pre2Tree(string Post, lnkStack<string>& str_Stack, BinaryTree<string> &t ){
...
int main(){
	...
	lnkStack<string> str_Stack;
	// string In = "101+202-303/3+404-0.1*606=";
	string In = "101/(202-303/3)+404-0.1*606=";
	string Post = "10.0 20.0 30.0 3.0 / - / 40.0 55.0 + + 0.1 66.0 * - =";
	// string str = "- + / 10.0 - 20.0 / 30.0 3.0  40.0 * 0.1 66.0 =";
	string str = "- 1 2 =";
	// string str = "10/(20-30/3)+(40+55)-0.1*66=";
	// string Pre = "- 1 2 =";
	// string In = "1+2+3=";
	// string In = "1/(2+2)=";
	// In2Post(In,Postfix);
	// Post2Post(Post, Postfix);
	// cout << endl;
	// Post2Tree(Postfix,Tree);
	// cout << endl;
	// Tree2In(Tree);
	// cout << endl;
	// Tree.print();
